...
;2012-02-25 flash instead of eeprom
...
prog_main:
	...
	save_pwm_sram_value r16, 0
	save_pwm_sram_value r16, 1
	save_pwm_sram_value r16, 2 
	save_pwm_sram_value r16, 3
	save_pwm_sram_value r16, 4

	mov r15, r16 
	ldi r16, 5
	mov r14, r16 ; simulate key 5 press 
...
loop_after_irprot_read:
	...
	load_y_pwm_new
	ldi r16, 0
	; save new pwm sram values
	save_pwm_sram_value_with_postinc r16
	save_pwm_sram_value_with_postinc r16
	save_pwm_sram_value_with_postinc r16
	save_pwm_sram_value_with_postinc r16
	save_pwm_sram_value_with_postinc r16
...
check_key_chup:
	...
	ld r0, Y
	rcall inc_checked
	save_pwm_sram_value_with_postinc r0
...
check_digit_key_load_preset:
	...
	ldi zh, high( num_keys_brightness_table * 2 )
	ldi zl,  low( num_keys_brightness_table * 2 )
...
num_keys_brightness_table:
	.DB 31,00,00,00,00,0,0,0  ;0
	.DB 00,06,06,06,06,0,0,0
	.DB 00,00,20,00,00,0,0,0  ;2
	.DB 00,11,11,11,11,0,0,0
	.DB 00,20,00,00,00,0,0,0  ;4
	.DB 00,17,17,17,17,0,0,0
	.DB 00,00,00,20,00,0,0,0  ;6
	.DB 00,25,25,25,25,0,0,0
	.DB 00,00,00,00,20,0,0,0  ;8
	.DB 00,31,31,31,31,0,0,0
...
show_vars_to_lcd:
	...
	ldi reg_pos_y,1
	ldi reg_pos_x,1
	load_pwm_sram_value r24, 1
	rcall put_char_hex

	ldi reg_pos_y,1
	ldi reg_pos_x,6
	load_pwm_sram_value r24, 2
	rcall put_char_hex

	ldi reg_pos_y,2
	ldi reg_pos_x,1
	load_pwm_sram_value r24, 3
	rcall put_char_hex

	ldi reg_pos_y,2
	ldi reg_pos_x,6
	load_pwm_sram_value r24, 4
	rcall put_char_hex
ret
...
switch_power_enable:
	...
	clr r1
	clr r0
	load_pwm_sram_value r16, 0
	or r0, r16
	load_pwm_sram_value r16, 1
	or r0, r16
	load_pwm_sram_value r16, 2
	or r0, r16
	or r0, r2
	cpse r0, r1
	...
	clr r0
	load_pwm_sram_value r16, 3
	or r0, r16
	load_pwm_sram_value r16, 4
	or r0, r16
	or r0, r2
	cpse r0, r1
